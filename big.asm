...
main()
{
  ...
  16:	00 
  17:	c7 04 24 68 08 00 00 	movl   $0x868,(%esp)
  1e:	e8 cf 03 00 00       	call   3f2 <open>
    if(fd < 0){
...
main()
{
  ...
  4b:	89 5c 24 10          	mov    %ebx,0x10(%esp)
        int cc = write(fd, buf, sizeof(buf));
  4f:	e8 7e 03 00 00       	call   3d2 <write>
        if(cc <= 0)
  ...
  6e:	75 c8                	jne    38 <main+0x38>
            printf(2, ".");
  70:	c7 44 24 04 71 08 00 	movl   $0x871,0x4(%esp)
  77:	00 
  78:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  7f:	e8 7c 04 00 00       	call   500 <printf>
  ...
  8c:	c7 44 24 04 73 08 00 	movl   $0x873,0x4(%esp)
  93:	00 
  ...
  af:	00 
  b0:	c7 04 24 68 08 00 00 	movl   $0x868,(%esp)
  b7:	e8 36 03 00 00       	call   3f2 <open>
    if(fd < 0){
  ...
  be:	89 c6                	mov    %eax,%esi
    if(fd < 0){
  c0:	0f 88 a5 00 00 00    	js     16b <main+0x16b>
        printf(2, "big: cannot re-open big.file for reading\n");
        exit();
    }
    for(i = 0; i < sectors; i++){
  c6:	31 ff                	xor    %edi,%edi
  c8:	85 db                	test   %ebx,%ebx
  ca:	75 13                	jne    df <main+0xdf>
  cc:	eb 4a                	jmp    118 <main+0x118>
  ce:	66 90                	xchg   %ax,%ax
 ...
 113:	e8 9a 02 00 00       	call   3b2 <exit>
    ...
    printf(1, "done; ok\n");
 118:	c7 44 24 04 86 08 00 	movl   $0x886,0x4(%esp)
 11f:	00 
 120:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 127:	e8 d4 03 00 00       	call   500 <printf>
    
    exit();
 12c:	e8 81 02 00 00       	call   3b2 <exit>
        if(cc <= 0){
            printf(2, "big: read error at sector %d\n", i);
            exit();
        }
 ...
 139:	c7 44 24 04 04 09 00 	movl   $0x904,0x4(%esp)
 140:	00 
 141:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
 148:	e8 b3 03 00 00       	call   500 <printf>
                   *(int*)buf, i);
            exit();
 14d:	e8 60 02 00 00       	call   3b2 <exit>
    char buf[512];
    int fd, i, sectors;
 ...
 152:	c7 44 24 04 b0 08 00 	movl   $0x8b0,0x4(%esp)
 159:	00 
 15a:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
 161:	e8 9a 03 00 00       	call   500 <printf>
        exit();
 166:	e8 47 02 00 00       	call   3b2 <exit>
    printf(1, "\nwrote %d sectors\n", sectors);
    ...
    if(fd < 0){
        printf(2, "big: cannot re-open big.file for reading\n");
 16b:	c7 44 24 04 d8 08 00 	movl   $0x8d8,0x4(%esp)
 172:	00 
 173:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
 17a:	e8 81 03 00 00       	call   500 <printf>
        exit();
 17f:	e8 2e 02 00 00       	call   3b2 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 499:	0f b6 92 3b 09 00 00 	movzbl 0x93b(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 62f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 631:	b8 34 09 00 00       	mov    $0x934,%eax
...
free(void *ap)
{
 ...
 737:	89 10                	mov    %edx,(%eax)
  freep = p;
 739:	a3 b4 0b 00 00       	mov    %eax,0xbb4
}
 73e:	5b                   	pop    %ebx
 73f:	5e                   	pop    %esi
 740:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 789:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 78c:	8b 1d b4 0b 00 00    	mov    0xbb4,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 7c9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 7cb:	3b 15 b4 0b 00 00    	cmp    0xbb4,%edx
...
morecore(uint nu)
{
 ...
 7fd:	e8 ee fe ff ff       	call   6f0 <free>
  return freep;
 802:	8b 15 b4 0b 00 00    	mov    0xbb4,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 83c:	eb e9                	jmp    827 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 83e:	c7 05 b4 0b 00 00 b8 	movl   $0xbb8,0xbb4
 845:	0b 00 00 
    base.s.size = 0;
 848:	ba b8 0b 00 00       	mov    $0xbb8,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 84d:	c7 05 b8 0b 00 00 b8 	movl   $0xbb8,0xbb8
 854:	0b 00 00 
    base.s.size = 0;
 857:	c7 05 bc 0b 00 00 00 	movl   $0x0,0xbbc
 85e:	00 00 00 
